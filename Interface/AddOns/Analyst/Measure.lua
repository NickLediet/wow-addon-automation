...
ANALYST_MEASURE_MONEY_GAINED_MISSIONS = "MONEY_GAINED_MISSIONS"
...
ANALYST_MEASURE_ITEM_PRODUCED_MISSIONS = "ITEM_PRODUCED_MISSIONS"
...
ANALYST_MEASURE_CURRENCY_GAINED_MISSIONS = "CURRENCY_GAINED_MISSIONS"
...
ANALYST_MEASURE_CURRENCY_SPENT_MISSIONS = "CURRENCY_SPENT_MISSIONS"
...
function Analyst:DefineMeasures ()
	...
	self:DefineMeasure(
		...
		ANALYST_DRILLDOWN_LIST,
			...
			ANALYST_MEASURE_MONEY_GAINED_RECEIVING, ANALYST_MEASURE_MONEY_GAINED_MISSIONS,
	...
	self:DefineMeasure(
		...
		ANALYST_DRILLDOWN_NONE)
	self:DefineMeasure(
		ANALYST_MEASURE_MONEY_GAINED_MISSIONS,
		ANALYST_MTYPE_MONEY,
		ANALYST_DRILLDOWN_DETAIL)
	self:DefineMeasure(
		ANALYST_MEASURE_MONEY_GAINED_MISCELLANEOUS,
	...
	self:DefineMeasure(
		...
		ANALYST_DRILLDOWN_DETAIL)
	self:DefineMeasure(
		ANALYST_MEASURE_ITEM_PRODUCED_MISSIONS,
		ANALYST_MTYPE_COUNT,
		ANALYST_DRILLDOWN_DETAIL)
	self:DefineMeasure(
	...
	self:DefineMeasure(
		...
		ANALYST_DRILLDOWN_LIST,
			...
			ANALYST_MEASURE_CURRENCY_GAINED_MISSIONS,
	...
	self:DefineMeasure(
		...
		ANALYST_DRILLDOWN_PRODUCED)
	self:DefineMeasure(
		ANALYST_MEASURE_CURRENCY_SPENT_MISSIONS,
		ANALYST_MTYPE_COUNT,
		ANALYST_DRILLDOWN_DETAIL)
	self:DefineMeasure(
	...
	self:DefineMeasure(
		...
		ANALYST_DRILLDOWN_LIST,
			...
			ANALYST_MEASURE_CRAFTING_INSCRIPTION, ANALYST_MEASURE_CRAFTING_JEWELCRAFTIN,
			ANALYST_MEASURE_CRAFTING_LEATHERWORKING, ANALYST_MEASURE_CRAFTING_MILLING,
...
function Analyst:DefineReports ()
	...
	self:DefineReport(ANALYST_REPORT_ITEM_PRODUCED,
		...
		ANALYST_MEASURE_ITEM_PRODUCED_MISSIONS, ANALYST_MEASURE_ITEM_PRODUCED_MISCELLANEOUS)
	self:DefineReport(ANALYST_REPORT_CURRENCY,
		...
		ANALYST_MEASURE_CURRENCY_SPENT_MISSIONS, ANALYST_MEASURE_CURRENCY_HONORABLE_KILL)
	...
	self:DefineReport(ANALYST_REPORT_CRAFTING,
		...
		ANALYST_MEASURE_CRAFTING_COOKING, ANALYST_MEASURE_CRAFTING_DISENCHANTING,
		ANALYST_MEASURE_CRAFTING_ENCHANTING, ANALYST_MEASURE_CRAFTING_ENGINEERING,
		ANALYST_MEASURE_CRAFTING_INSCRIPTION, ANALYST_MEASURE_CRAFTING_JEWELCRAFTING,
		ANALYST_MEASURE_CRAFTING_LEATHERWORKING, ANALYST_MEASURE_CRAFTING_MILLING,
		ANALYST_MEASURE_CRAFTING_PROSPECTING, ANALYST_MEASURE_CRAFTING_SMELTING,
		ANALYST_MEASURE_CRAFTING_TAILORING)
...
-- Handles MISSIONS activity
function Analyst:MISSIONS (day, detail, consumed, produced)
	local detailObj = self:ParseObject(detail)
	if detailObj.objType == ANALYST_OTYPE_STRING then
		local consumedObjs = self:ParseObjects(consumed)
		for _, consumedObj in ipairs(consumedObjs) do
			if consumedObj.objType == ANALYST_OTYPE_CURRENCY then
				self:CreateFact(
					ANALYST_MEASURE_CURRENCY_SPENT_MISSIONS,
					day,
					consumedObj.currencyName,
					consumedObj.count)
			end
		end
		local producedObjs = self:ParseObjects(produced)
		for _, producedObj in ipairs(producedObjs) do
			if producedObj.objType == ANALYST_OTYPE_ITEM then
				self:CreateFact(
					ANALYST_MEASURE_ITEM_PRODUCED_MISSIONS,
					day,
					producedObj.itemName,
					producedObj.count)
			elseif producedObj.objType == ANALYST_OTYPE_MONEY then
				self:CreateFact(
					ANALYST_MEASURE_MONEY_GAINED_MISSIONS,
					day,
					detailObj.s,
					producedObj.copper)
			elseif producedObj.objType == ANALYST_OTYPE_CURRENCY then
				self:CreateFact(
					ANALYST_MEASURE_CURRENCY_GAINED_MISSIONS,
					day,
					producedObj.currencyName,
					producedObj.count)
			end
		end
	end
